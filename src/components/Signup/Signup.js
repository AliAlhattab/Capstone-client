    ...
    return (
      <section className="signup">
        ...
        <form className="signup__form" onSubmit={this.register}>
          ...
          <input className={`signup__input ${this.state.first_nameError ? 'signup__input-error': ''}`} 
          ...
          <input className={`signup__input ${this.state.last_nameError ? 'signup__input-error': ''}`} 
          onChange={this.changeHandler}
          id='last_name'
          name="last_name"
          type='text'
          ...
          <input className={`signup__input ${this.state.usernameError ? 'signup__input-error': ''}`} 
          onChange={this.changeHandler}
          id='username'
          name="username"
          type='text'
          ...
          <input className={`signup__input ${this.state.passwordError ? 'signup__input-error': ''}`} 
          onChange={this.changeHandler}
          id='password'
          name="password"
          type='password'
